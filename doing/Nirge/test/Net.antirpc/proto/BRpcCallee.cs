...
namespace Nirge.Core {
  [CRpcService(1)]
  public class CBRpcCallee : CRpcCallee<IBRpcService> {
    public CBRpcCallee(CRpcCalleeArgs args, ILog log, IRpcStream stream, IRpcTransfer transfer, IBRpcService service)
    	: base(args, log, stream, transfer, global::Nirge.Core.AReflection.Descriptor.Services[1], service) {}
