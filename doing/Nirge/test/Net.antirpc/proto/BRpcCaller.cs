...
namespace Nirge.Core {
  public class CBRpcCaller : CRpcCaller {
    public CBRpcCaller(CRpcCallerArgs args, ILog log, IRpcStream stream, IRpcTransfer transfer, IRpcCallStubProvider stubs)
    	: base(args, log, stream, transfer, stubs, global::Nirge.Core.AReflection.Descriptor.Services[1], 1) {}
