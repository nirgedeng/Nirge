...
public sealed partial class G2C_SYNC_ROLE_DATA_BEGIN : pb::IMessage<G2C_SYNC_ROLE_DATA_BEGIN> {
  ...
  public G2C_SYNC_ROLE_DATA_BEGIN(G2C_SYNC_ROLE_DATA_BEGIN other) : this() {
    ...
    talentList_ = other.talentList_ != null ? other.talentList_.Clone() : null;
    talentSlotList_ = other.talentSlotList_;
    roleVarList_ = other.roleVarList_ != null ? other.roleVarList_.Clone() : null;
    ...
    dailyLimit_ = other.dailyLimit_ != null ? other.dailyLimit_.Clone() : null;
    weeklyLimit_ = other.weeklyLimit_ != null ? other.weeklyLimit_.Clone() : null;
    sgem_ = other.sgem_ != null ? other.sgem_.Clone() : null;
